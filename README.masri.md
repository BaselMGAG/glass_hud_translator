...
أول مرة تفتح البرنامج هيمشيك هو بنفسه على كل حاجة — اللغة، والمفتاح، واللعبة، ومكان الكلام — في
أربع خطوات تقدر تعدّي أي واحدة فيهم. اللي تحت ده نفس الكلام بس بإيدك، ومرجع لو احتجته بعدين.
...
<div align="center">
<img src="docs/images/toolbar-simple.png" alt="شريط الأزرار العايم بشكله البسيط: تمن أزرار صغيرة في شريط غامق" width="300">
<br>
<sub>الشكل البسيط: ستة أزرار، وزرار بيفتح الباقي، وزرار بيطوي الشريط.</sub>
<br><br>
<img src="docs/images/toolbar-advanced.png" alt="نفس الشريط وهو مفتوح، وفيه خمس أزرار زيادة بعد فاصل" width="470">
<br>
<sub>وهو مفتوح، والترجمة التلقائية والبرواز شغالين — الأزرار الشغالة بتنوّر.</sub>
<br><br>
<img src="docs/images/toolbar-tooltip.png" alt="نفس التلميح باللغتين جنب بعض" width="480">
<br>
<sub>نفس الزرار: على الشمال والبرنامج بالإنجليزي، وعلى اليمين والبرنامج بالعربي. اللغتين موجودين
على طول، واللي إنت مختاره هو اللي فوق.</sub>
</div>

<div dir="rtl" align="right">

## تحرّك الحاجات اللي في وشّك

دوس على زرار **الإيد** في الشريط — أو «حرّك العناصر» من **الإعدادات ← الترجمة** — والبرواز
بتاع الالتقاط ولوحة الترجمة الاتنين هيبقوا في إيدك. اسحب اللي إنت عايزه لأي مكان، واسحب من ركن
البرواز عشان تكبّره أو تصغّره. والاتنين هيبقى حواليهم إطار وإنت ماسكهم، عشان تعرف إنت في أنهي وضع.

دوس عليه تاني يتثبّتوا تاني: الإطار يروح والنقر يرجع يعدّي للعبة عادي. ودي الحالة الوحيدة اللي
بياخدوا فيها نقرة منك، عشان كده هي زرار واحد إنت اللي بتدوسه — مش حاجة البرنامج يقع فيها لوحده.
...
**ولو مش عارف تختار:** في **الإعدادات ← الترجمة ← «ما الذي على الشاشة»** فيه اختيار تالت اسمه
**«اكتشفه بنفسك»**. البرنامج هيبص على الكلام بنفسه ويعرف: هو ده حوار قاعد مستنيك تدوس، ولا ترجمة
فيلم بتيجي وتمشي لوحدها؟ ويظبّط التوقيت على كده. يعني لو اللعبة فيها مشهد سينمائي، هياخد توقيت
الفيديو لوحده، ولما يخلص المشهد يرجع لتوقيت الحوار — من غير ما تفتح أي قايمة.

**ولو بتتفرّج على فيديو:** روح **الإعدادات ← الترجمة ← «ما الذي على الشاشة»** واختار **«ترجمة
فيديو»** — أو دوس نفس الزرار اللي في شريط الأزرار، بيلفّ على التلاتة: حوار، فيديو، اكتشفه بنفسك. ترجمة الفيديو بتظهر كاملة ومابتقعدش غير تلات أربع ثواني، فالبرنامج لو استنى الكلام يستقر
— وده الصح في الألعاب — الترجمة بتوصل بعد ما السطر يكون مشي خلاص. في وضع الفيديو بيبص أكتر وبيستنى
أقل بكتير. ومن نسخة 0.7.0 بقا أسرع كمان بنص ثانية تقريباً في كل سطر، وبقا يقدر يلحق الترجمات
السريعة اللي كان بيفوّتها قبل كده.
...
## لو الترجمة نفسها طلعت وحشة

**اطلبها تاني.** `Ctrl + Shift + G`، أو من شريط الأزرار. بيطلب ترجمة جديدة ومش بيرجّعلك المحفوظة —
وده هو المطلوب أصلاً، لإن المحفوظة هي اللي إنت عايز تغيّرها. بتكلّف طلب، والكلام اللي جنب الزرار
بيقولك كده.

**ولو هو أصلاً قرا الإنجليزي غلط؟** صلّح الإنجليزي بنفسك من **الإعدادات ← الترجمة** وخلّيه يترجم
اللي إنت كتبته. ولو ضغطت الزرار والخانة فاضية هيملاهالك بالكلام اللي قراه فعلاً، فتصلّح كلمة بدل
ما تكتب الجملة من الأول.

**كلام إنت مش عايزه يتترجم خالص.** سطر في كل خانة، من **الإعدادات ← الترجمة**. أي كلام يطابقه
البرنامج بيعديه من غير ما يبعت حاجة، يعني ما بيكلّفش ولا مليم. ده للحاجات زي كلام الأزرار أو أي
لافتة في اللعبة بتدخل في المربع بتاعك — دي بتتقري كل مرة شكل، فكانت كل مرة تتحسب طلب جديد.

**كل اللي اتترجم من أول يوم.** **الإعدادات ← السجل**، الأحدث الأول، وتقدر تدوّر بالإنجليزي أو
بالعربي أو باسم اللي بيتكلم. صلّح العربي واحفظه، والسطر ده يبقى متصلّح في أي مكان يظهر فيه بعد
كده — مش في القايمة بس.

**قارئ تاني للكلام اللي الأول ما عرفش يقراه.** **الإعدادات ← المزوّدين**، وهو مطفي من الأول.
تشغيله قرار مش مجرد تسهيل: لإنه بيبعت **صورة** من جزء من الشاشة بتاعتك، بينما أي حاجة تانية
البرنامج بيبعتها بتبقى كلام اتقرا على جهازك إنت. ولو شغّلته، الشاشة اللي فيها كلام باين بس مش
مقروء بياخد رأي تاني من موديل بيشوف الصورة — والقراءة دي بتتقارن باللي قبلها وبتترمي لو مختلفة
أوي. والجزء ده هو المهم: الغلط في النوع ده من القرايا بيبقى جملة عربي حلوة ومظبوطة الشكل بس ما
كانتش على الشاشة أصلاً، وده اللي محدش يقدر يكشفه.

## لو حصلت مشكلة

**البرنامج نفسه مش راضي يفتح؟**
دوّر جنب البرنامج على ملف اسمه `startup.log` — البرنامج بيكتبه من أول لحظة بيشتغل فيها. لو الملف
مش موجود يبقى البرنامج ما اشتغلش أصلاً، وده غالباً معناه إن الأنتي فايروس مسحه: افتح الأنتي
فايروس وشوف الـQuarantine ورجّع الملفات، أو فكّ ضغط التنزيل من أول وجديد. لو الملف موجود، آخر
سطر فيه بيقول إيه اللي حصل بالظبط — ابعتهولي زي ما هو. ولو البرنامج وقع وهو بيفتح هتظهرلك دلوقتي
نافذة عادية فيها الخطأ مكتوب بالعربي والإنجليزي، تقدر تنسخه منها.

**حاسس إن فيه حاجة غلط ومش عارف إيه؟**
افتح **الإعدادات ← التشخيص** واضغط **«افحص الآن»**. زرار واحد بيفحص كل حاجة — اللعبة، والمفاتيح،
وقراءة الكلام، ومنطقة الالتقاط — وبيقولك لقى إيه بالعربي، والأهم في الأول. اللي بيكتبه ده هو نفسه
تقرير المشكلة: شغّله قبل ما تبعتلي.
...
واستعمل `Space` تشوف البرنامج قرا إيه قبل ما تحفظ. وبالمناسبة: أول ما الشاشة تتجمد هتلاقي
البرنامج نفسه بيرسملك صناديق خضرا حوالين الكلام اللي شايفه — دوس على واحد منهم وخلاص، من غير
ما ترسم حاجة.

**الترجمة عالقة على الشاشة؟**
دوس كليك يمين على أيقونة البرنامج اللي جنب الساعة تحت، واختار «أغلق Glass HUD Translator» —
هيقفل كل حاجة على نضافة.
