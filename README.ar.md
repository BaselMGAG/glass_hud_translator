...
الستة كلها قابلة لإعادة التعيين من الإعدادات ← تبويب **الاختصارات**. المُعدِّلات هي Ctrl و Shift
...
| | |
|---|---|
| مسار الترجمة الكامل (قراءة ← تنظيف ← تخزين ← نموذج لغوي ← عرض) | يعمل، ٥٤٢ اختباراً |
