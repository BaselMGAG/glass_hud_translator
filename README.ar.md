...
**٣. الصق المفتاح.** الإعدادات ← تبويب **Providers** ← الصق ← احفظ. تُخزَّن المفاتيح مشفَّرة بحساب
...
<div align="center">
<img src="docs/images/settings-providers.png" alt="تبويب Providers في الإعدادات، وفيه خانة مفتاح لكل من Google Gemini و Groq و OpenAI و Anthropic Claude، مع بيان المجاني والمدفوع والنماذج التي يجرّبها كل مزوّد بالترتيب" width="820">
</div>
...
الخمسة كلها قابلة لإعادة التعيين من الإعدادات ← تبويب **Hotkeys**. المُعدِّلات هي Ctrl و Shift
...
Ctrl+F13      ←  ترجمة ما هو على الشاشة الآن   (في الإعدادات ← Hotkeys)
```
...
**لا يحدث شيء؟** تبويب **Diagnostics** يعرض الحصة المستهلكة اليوم، ونسبة الإصابة في الذاكرة
المؤقتة، ومحرّك القراءة الضوئية الذي حُمِّل فعلاً، وسجلّ الموجِّه الذي يسمّي أي مزوّد أو نموذج
أخفق. وتبويب **Providers** يسرد المسارات بالترتيب الذي ستُجرَّب به ويشير إلى ما لا مفتاح له.
...
<div align="center">
<img src="docs/images/settings-translating.png" alt="تبويب Translating في الإعدادات، ويظهر فيه محدّد الملف على ffxiv، ومحدّد اللهجة على العربية الفصحى، وأزرار تحديد مناطق الحوار والترجمة والمهام، وخانة لتثبيت تصحيح" width="820">
<br>
...
| | |
|---|---|
| مسار الترجمة الكامل (قراءة ← تنظيف ← تخزين ← نموذج لغوي ← عرض) | يعمل، ١٥٩ اختباراً |
...
ملف اللعبة مجرّد مجلد — بلا شيفرة وبلا إعادة بناء. لا شيء في المسار مرتبط بلعبة بعينها؛ ما يختلف
هو موضع النص على الشاشة، وأسماء الأعلام، والأسلوب المطلوب.
...
`styleHint` الذي يُمرَّر مباشرة إلى النموذج. وهذا الحقل أهم مما يبدو: عبارة «ثرثرة عسكرية مقتضبة
عبر اللاسلكي» وعبارة «كلام بلاطي رسمي من العصور الوسطى» تنتجان عربية مختلفة تماماً من النموذج نفسه.

ويثبّت `glossary.json` أسماء الأعلام، وهو أقوى عامل لتحسين الجودة على الإطلاق: بدونه يخترع النموذج
...
ضع المجلد، أعد التشغيل، انتهى الأمر. المساهمة بملفات ألعاب مرحَّب بها كثيراً.
