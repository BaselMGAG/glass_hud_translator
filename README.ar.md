...
لكنها ليست وضعاً تتركه ويعمل وحده: فهي لا تتوقّف تلقائياً إلا بعد ٩٠ ثانية **بلا أي نص جديد**،
والحوار الذي يتقدّم يبقيها عاملة ويبقيها تستهلك من حصتك اليومية. اضغط `Ctrl+Shift+A` مرة أخرى عند
انتهاء المشهد. وحدٌّ زمني مع تنبيه هو الشيء التالي الذي يُبنى.
...
| | |
|---|---|
| مسار الترجمة الكامل (قراءة ← تنظيف ← تخزين ← نموذج لغوي ← عرض) | يعمل، ٥٢٤ اختباراً |
...
فهي لا تتوقّف تلقائياً إلا بعد ٩٠ ثانية **بلا أي نص جديد**، والحوار الطويل يبقيها عاملة. ولم تعد
تدفع ثمن الجملة الواحدة عدة مرات وهي تظهر على الشاشة، إذ صارت تنتظر استقرار النص أولاً، لكن جلسة
منسيّة ما زالت قد تستهلك من حصتك ما لم تقصده. حدٌّ زمني وتنبيه قادمان.
