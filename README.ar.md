...
**أيّ نافذة.** اختر لعبتك من قائمة ما هو مفتوح — عندها تُقاس المنطقة التي ترسمها على تلك النافذة،
فتحريكها لا يفسد شيئاً. ويُسجَّل اسم البرنامج مع العنوان، لأن العناوين تتغيّر أثناء اللعب أما
`ffxiv_dx11.exe` فلا يتغيّر. واتركها على «أي شيء على الشاشة» للمتصفّح أو مشغّل الفيديو.
