...
**جادِل السطر بدل أن تتفرّج عليه وهو يمضي.** إن جاءت ترجمة رديئة، `Ctrl+Shift+G` يطلب ترجمة
جديدة ويتجاهل المحفوظة — وهذا هو المقصود، فالمحفوظة هي ما تريد استبداله. وإن كانت المشكلة أبعد من
ذلك وقرأ البرنامج **الإنجليزية** خطأً، صحّحها في الإعدادات ← **الترجمة** وترجم المصحَّح؛ والضغط على
الزر والصندوق فارغ يملؤه بما قُرئ فعلاً، فتصحّح كلمة بدل أن تعيد كتابة جملة.

**أسطر لا تريد ترجمتها أبداً.** سطر في كل صف، في الإعدادات ← **الترجمة**. ما يطابقها يُتخطّى قبل
إرسال أي شيء، فلا يكلّف شيئاً على الإطلاق. وهو موجّه إلى ما لا تنفع فيه الذاكرة المؤقتة: عبارة زر أو
لافتة في الواجهة تدخل منطقة الالتقاط تُقرأ قراءة مختلفة قليلاً في كل مرة، فكان كل ظهور لها طلباً
جديداً.

**كل ما تُرجم يوماً.** الإعدادات ← **السجلّ**، الأحدث أولاً، بحث بالإنجليزية أو العربية أو باسم
المتحدّث. صحّح العربية واحفظها فيُصحَّح ذلك السطر أينما ظهر بعد ذلك — لا في القائمة وحدها. ومن هنا
أيضاً تعيد ترجمته، أو تضيفه إلى قائمة ما لا يُترجَم، وهي التي تأخذ النصّ بالضبط من هنا.

**قارئ ثانٍ حين يعجز الأول عن تبيّن الكلمات.** الإعدادات ← **المزوّدون**، وهو مطفأ افتراضياً.
تشغيله قرار حقيقي لا مجرّد تسهيل: فهو يرسل **صورة** من جزء من شاشتك إلى مزوّد، بينما كل ما يرسله
البرنامج غير ذلك نصّ قُرئ على جهازك أنت. وحين يكون مشتغلاً، الإطار الذي فيه كلمات ظاهرة لم يُقرأ
منها شيء يحصل على رأي ثانٍ من نموذج يستطيع النظر إلى الصورة — وتُقارَن تلك القراءة بالأولى وتُطرَح
إن اختلفت عنها كثيراً. وهذا النصف هو المهم: خطأ هذا النوع من القرّاء جملة فصيحة مقنعة لم تكن على
الشاشة أصلاً، والعربية الفصيحة الخاطئة لا يستطيع كشفها من بُني هذا البرنامج من أجله.
...
| وضع ترجمة الفيديو | **يعمل** — أسرع لكل سطر منذ v0.7.0، وتوقّف في v0.8.0 عن ألّا يترجم شيئاً إطلاقاً |
...
| طلب ترجمة جديدة لسطر جاءت ترجمته رديئة | **يعمل** |
| تصحيح ما قُرئ ثم إعادة ترجمته | **يعمل** |
| قائمة أسطر لا تُترجَم أبداً | **تعمل** |
| سجلّ بكل سطر تُرجم، قابل للبحث والتصحيح | **يعمل** |
| قارئ ثانٍ للنصّ الذي يعجز الأول عن قراءته | **يعمل** — مطفأ افتراضياً، انظر الإعدادات ← المزوّدون |
| كتابة تقرير ذاتي يمكنك إرساله | **يعمل** |
